...
module.exports = function makeWebpackConfig() {
   ...
   */
  config.entry = isTest ? {} : {
    'polyfills': './ng2-app/polyfills.ts',
    'vendor': './ng2-app/vendor.ts',
    'app': './ng2-app/main.ts' // our angular app
  };
  ...
  if (!isTest && !isTestWatch) {
    config.plugins.push(
      ...
      new HtmlWebpackPlugin({
        template: './ng2-app/public/index.html',
